...
const BentoGrid = ({ children, className, ...props }: BentoGridProps) => {
  return (
    <div
      className={cn(
        'grid w-full auto-rows-[18rem] lg:auto-rows-[22rem] grid-cols-3 gap-4',
        className,
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  >
    ...
    <div
      ...
      <Icon
        className="h-12 w-12 origin-left transform-gpu text-zinc-500 transition-all duration-300 ease-in-out group-hover:scale-75" />
